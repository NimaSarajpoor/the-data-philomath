...
(0) Provided text data -> a certain set of vectors on n-dim Euclidean space (Embedding data) <br>
(1) User: "THIS IS MY QUERY"  -> converted to one (or more?) vectors (Embedding query) <br>
(2) Find the similarities between (1) and (0), and return top-k matches <br>
...
Note that we tried cosine similarity here. But...two questions come to my mind: <br>
(1) How to know cosine-similarity is the correct distance metric? <br>
(2) What if embeddings are based on semantic meaning.... then does it still make sense to use cosine-similarity? <br>
